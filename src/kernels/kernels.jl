...
function mu2D_apply_kernel_and_h(
    mu,
    NC::Int64,
    kernels::Array{<:Function,1};
    dims::Array = [1, 2],
)
...
"""
function mu2D_apply_kernel_and_h_no_mutate(
    mu,
    NC::Int64,
    kernel::Function;
    dims::Array = [1, 2],
...
mu3D_apply_kernel_and_h_no_mutate(args...; kwargs...) =
    muND_apply_kernel_and_h_no_mutate(args...; kwargs...)
