...
@testset "two-site analytic pairing-channel fixed point" begin
    ...
    # For these fixed parameters the equation has two interior roots while
    # both stated interval endpoints have the same sign. Bracket the larger,
    # stable paired branch before applying bisection.
